...
import irs.fdxtax641.jsonserializers.Tax1099SSerializer;
import irs.fdxtax641.map2objects.Map2Tax1099S;
import org.taxdataexchange.core.pdfbuilders.Tax1099SPdfBuilder;
...
public class Tax1099SDocumentGenerator {
    ...
    private void processOneRow(
        ...
        Tax1099S obj = Map2Tax1099S.generate( row );
        {
            String asJson = Tax1099SSerializer.serialize( obj );
    ...
    private void processCsvForCompany(
        ...
        // CSV file
        String csvFileName  = "Tax1099S.csv";
        ...
        String outputFileName = "Tax1099S.rows.json";
    ...
    public static void main(String[] args) {
        ...
        Tax1099SDocumentGenerator generator = new Tax1099SDocumentGenerator( );
