# tax-doc-sdk-tax1099s

Software development kit to generate IRS Form 1099-S as PDF file using Financial Data Exchange (FDX) standards including QR codes and embedded JSON.

<img alt="Sample Form" src="samples/Tax1099S.sample.png" width="850"/>
